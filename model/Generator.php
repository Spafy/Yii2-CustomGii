...
class Generator extends \yii\gii\Generator
{
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $params = [
                'customBehaviors' => $this->getBehaviors($tableSchema) ,
                'tableName' => $tableName,
    ...
    public function getBehaviors($table)
    {
 
        $behaviors=[];
        foreach ($table->columns as $column) {
       
            if (in_array($column->name, ['created_at','updated_at','created_by','updated_by'])) $behaviors[] = $column->name; 
        }
